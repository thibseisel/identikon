...
object Colors {
    ...
    const val GRAY = 0xFFBEBEBE.toInt()
    const val GREY = 0xFFBEBEBE.toInt()
    const val WEB_GRAY = 0xFF808080.toInt()
    const val WEB_GREY = 0xFF808080.toInt()
    ...
    const val LIGHT_SLATE_BLUE = 0xFF8470FF.toInt()
    ...
    const val MEDIUM_AQUAMARINE = 0xFF66CDAA.toInt()
    ...
    const val WEB_GREEN = 0xFF008000.toInt()
    ...
    const val PALE_GOLDENROD = 0xFFEEE8AA.toInt()
    const val LIGHT_GOLDENROD_YELLOW = 0xFFFAFAD2.toInt()
    const val LIGHT_YELLOW = 0xFFFFFFE0.toInt()
    const val YELLOW = 0xFFFFFF00.toInt()
    const val GOLD = 0xFFFFD700.toInt()
    const val LIGHT_GOLDENROD = 0xFFEEDD82.toInt()
    const val GOLDENROD = 0xFFDAA520.toInt()
    const val DARK_GOLDENROD = 0xFFB8860B.toInt()
    ...
    const val MAROON = 0xFFB03060.toInt()
    const val WEB_MAROON = 0xFF800000.toInt()
    const val MEDIUM_VIOLET_RED = 0xFFC71585.toInt()
    const val VIOLET_RED = 0xFFD02090.toInt()
    ...
    const val PURPLE = 0xFFA020F0.toInt()
    const val WEB_PURPLE = 0xFF800080.toInt()
